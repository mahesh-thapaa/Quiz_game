...
class StadiumQuizGameplayScreen extends StatefulWidget {
  ...
  const StadiumQuizGameplayScreen({
    super.key,
...
class _StadiumQuizGameplayScreenState extends State<StadiumQuizGameplayScreen>
  ...
  StadiumAnswerOption _getState(int index) {
    ...
    if (index == _selectedIndex) return StadiumAnswerOption.wrong;
      ...
      body: Stack(
        children: [
          SafeArea(
            child: Column(
              children: [
                StadiumQuizTopBar(onBack: () => _safePop(null)),
                Padding(
