...
class StadiumBonus extends StatelessWidget {
  final VoidCallback? onPlay;
  final bool isUnlocked;
  final int unlockAtLevel; // ✅ which level must be completed to unlock

  const StadiumBonus({
    super.key,
    this.onPlay,
    this.isUnlocked = false,
    this.unlockAtLevel = 5, // ✅ default is level 5
  });
...
void showBonusLevelSheet({
  ...
  int unlockAtLevel = 5, // ✅ pass different level per quiz section
}) {
  showDialog(
    context: context,
    barrierColor: Colors.black.withValues(alpha: 0.7),
    barrierDismissible: true,
    builder: (context) => StadiumBonus(
      onPlay: onPlay,
